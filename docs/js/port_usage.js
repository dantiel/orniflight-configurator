...
PortUsage = {
  ...
  update: function() {
    var port_usage_down, port_usage_up;
    if (serial.bitrate) {
      port_usage_down = parseInt((serial.bytesReceived - this.previous_received) * 10 / serial.bitrate * 100);
      port_usage_up = parseInt((serial.bytesSent - this.previous_sent) * 10 / serial.bitrate * 100);
