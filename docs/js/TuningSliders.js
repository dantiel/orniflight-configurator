...
TuningSliders.initGyroFilterSliderPosition = function() {
  this.gyroFilterSliderValue = Math.round((FILTER_CONFIG.gyro_lowpass_dyn_min_hz + FILTER_CONFIG.gyro_lowpass_dyn_max_hz + FILTER_CONFIG.gyro_lowpass2_hz) / (this.FILTER_DEFAULT.gyro_lowpass_dyn_min_hz + this.FILTER_DEFAULT.gyro_lowpass_dyn_max_hz + this.FILTER_DEFAULT.gyro_lowpass2_hz) * 100) / 100;
...
TuningSliders.initDTermFilterSliderPosition = function() {
  this.dtermFilterSliderValue = Math.round((FILTER_CONFIG.dterm_lowpass_dyn_min_hz + FILTER_CONFIG.dterm_lowpass_dyn_max_hz + FILTER_CONFIG.dterm_lowpass2_hz) / (this.FILTER_DEFAULT.dterm_lowpass_dyn_min_hz + this.FILTER_DEFAULT.dterm_lowpass_dyn_max_hz + this.FILTER_DEFAULT.dterm_lowpass2_hz) * 100) / 100;
...
TuningSliders.updatePidSlidersDisplay = function() {
  var WARNING_DMAX_GAIN, WARNING_DMIN_GAIN, WARNING_I_GAIN, WARNING_P_GAIN, currentPIDs;
  WARNING_P_GAIN = 70;
  WARNING_I_GAIN = 120;
  ...
  $('.subtab-pid .slidersWarning').toggle((PIDs[1][0] > WARNING_P_GAIN || PIDs[1][1] > WARNING_I_GAIN || PIDs[1][2] > WARNING_DMAX_GAIN || ADVANCED_TUNING.dMinPitch > WARNING_DMIN_GAIN) && !this.pidSlidersUnavailable);
};

TuningSliders.updateFilterSlidersDisplay = function() {
  var WARNING_FILTER_HIGH_GAIN, WARNING_FILTER_LOW_GAIN;
  ...
  if ($('.pid_filter input[name="gyroLowpassDynMinFrequency"]').val() !== Math.round(this.FILTER_DEFAULT.gyro_lowpass_dyn_min_hz * this.gyroFilterSliderValue) || $('.pid_filter input[name="gyroLowpassDynMaxFrequency"]').val() !== Math.round(this.FILTER_DEFAULT.gyro_lowpass_dyn_max_hz * this.gyroFilterSliderValue) || $('.pid_filter select[name="gyroLowpassDynType"]').val() !== this.FILTER_DEFAULT.gyro_lowpass_type || $('.pid_filter input[name="gyroLowpass2Frequency"]').val() !== Math.round(this.FILTER_DEFAULT.gyro_lowpass2_hz * this.gyroFilterSliderValue) || $('.pid_filter select[name="gyroLowpass2Type"]').val() !== this.FILTER_DEFAULT.gyro_lowpass2_type) {
  ...
  if ($('.pid_filter input[name="dtermLowpassDynMinFrequency"]').val() !== Math.round(this.FILTER_DEFAULT.dterm_lowpass_dyn_min_hz * this.dtermFilterSliderValue) || $('.pid_filter input[name="dtermLowpassDynMaxFrequency"]').val() !== Math.round(this.FILTER_DEFAULT.dterm_lowpass_dyn_max_hz * this.dtermFilterSliderValue) || $('.pid_filter select[name="dtermLowpassDynType"]').val() !== this.FILTER_DEFAULT.dterm_lowpass_type || $('.pid_filter input[name="dtermLowpass2Frequency"]').val() !== Math.round(this.FILTER_DEFAULT.dterm_lowpass2_hz * this.dtermFilterSliderValue) || $('.pid_filter select[name="dtermLowpass2Type"]').val() !== this.FILTER_DEFAULT.dterm_lowpass2_type) {
...
TuningSliders.calculateNewPids = function() {
  var MAX_DMIN_GAIN, MAX_FF_GAIN, MAX_PID_GAIN, i, j;
  MAX_PID_GAIN = 200;
  MAX_DMIN_GAIN = 100;
  MAX_FF_GAIN = 2000;
  if (this.dMinFeatureEnabled) {
