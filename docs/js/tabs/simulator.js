...
'use strict';
var DEFAULT_ARRANGEMENT, DT, PI, TWO_PI;
...
TABS.simulator._applyWingGeometry = function() {
  var i, j, k, n, p, ref, ref1, ref2, self, t, yPositions;
  self = this;
  if (!self.model) {
    return;
  }
...
TABS.simulator._initModel = function() {
  var canvas, e, fp, i, j, k, n, p, ref, ref1, ref2, ref3, self, t, waveEl, wrapper, yPositions;
  self = this;
  self._slew = {
    freq: 0.0,
    freqMod: 1.0,
